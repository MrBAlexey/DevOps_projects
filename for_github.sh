...
for dir in ./*; do
  for project_name in ./*/*; do
    ...
    CHANGELOG \
    LICENSE \
    README.md README_RUS.md .gitignore .gitattributes
    cd .. || exit
  done
...
for dir in ./*; do
  cd "$dir" || continue
  rm -rf .git code-samples data-samples datasets materials misc ACTIVE_TAG_FILES.txt CHANGELOG LICENSE README.md README_RUS.md .gitignore .gitattributes
  cd .. || exit
done
